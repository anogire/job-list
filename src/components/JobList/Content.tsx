            ...
            <div className="w-full flex flex-col md:flex-row">
              <div className="w-full flex flex-col justify-between md:mr-7 xl:mr-48">
                ...
                <div className="flex items-center">
                  <img src="./images/address.svg" width="13px" height="18px" className="inline mr-2" alt="address marker" />
              ...
              <div className="w-full flex justify-between order-first mb-3 md:w-1/2 lg:w-1/3 md:order-last md:mb-0">
                <div className="flex shrink-0 items-center opacity-70 mr-5 md:opacity-100 md:mr-7">
                  <img src="./images/star.svg" width="19px" height="18px" className="h-2.5 md:h-3.5 lg:h-auto" alt="rating star" />
                  <img src="./images/star.svg" width="19px" height="18px" className="h-2.5 md:h-3.5 lg:h-auto" alt="rating star" />
                  <img src="./images/star.svg" width="19px" height="18px" className="h-2.5 md:h-3.5 lg:h-auto" alt="rating star" />
                  <img src="./images/star.svg" width="19px" height="18px" className="h-2.5 md:h-3.5 lg:h-auto" alt="rating star" />
                  <img src="./images/star.svg" width="19px" height="18px" className="h-2.5 md:h-3.5 lg:h-auto" alt="rating star" />
                ...
                <div className="flex flex-col justify-between items-end">
                  <img src="./images/flag.svg" width="18px" height="23px" className="h-5 hidden md:inline" alt="location marker" />
